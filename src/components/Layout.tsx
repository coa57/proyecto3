  ...
  return (
    <>
      ...
      <footer>
        <div>
          <b>✦ Casa Aurora</b>
          <p>Hospitalidad serena, atención memorable.</p>
        </div>

        <div>
          <b>Contacto</b>
          <p>Av. Las Palmeras 145 · Sucre</p>
          <p>+591 700 123 45 · hola@casaaurora.bo</p>
        </div>

        <div>
          <b>Descubre</b>
          <p>Habitaciones · Servicios</p>
          <p>© 2026 Casa Aurora</p>
        </div>
      </footer>
    </>
  );
