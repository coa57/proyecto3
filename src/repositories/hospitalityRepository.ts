import { reviews as seedReviews, rooms as seedRooms, services as seedServices } from "../data/catalog";
import { storageService } from "../services/storageService";
import type { ExtraService, Reservation, Review, Room } from "../types/hospitality";
...
export const hospitalityRepository = {
  rooms: () => get<Room[]>("stay_rooms", seedRooms), services: () => get<ExtraService[]>("stay_services", seedServices), reviews: () => get<Review[]>("stay_reviews", seedReviews), reservations: () => get<Reservation[]>("stay_reservations", []),
  saveRooms: (value: Room[]) => set("stay_rooms", value), saveServices: (value: ExtraService[]) => set("stay_services", value), saveReviews: (value: Review[]) => set("stay_reviews", value),
